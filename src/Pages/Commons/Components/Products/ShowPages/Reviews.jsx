                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="review_item">
                            ...
                            <div className="d-flex">
                                <img src={ require("../../../../../Assets/img/product/single-product/review-1.png")} alt='' />
                            </div>
                        ...
                        <div className="review_item reply">
                            <div className="media">
                            <div className="d-flex">
                                <img src={ require("../../../../../Assets/img/product/single-product/review-2.png")} alt='' />
                            </div>
                            <div className="media-body">
                                <h4>Blake Ruiz</h4>
                                <h5>12th Feb, 2017 at 05:56 pm</h5>
                        ...
                        <div className="review_item">
                            <div className="media">
                            <div className="d-flex">
                                <img src={ require("../../../../../Assets/img/product/single-product/review-3.png")} alt='' />
                            </div>
                            <div className="media-body">
                                <h4>Blake Ruiz</h4>
                                <h5>12th Feb, 2017 at 05:56 pm</h5>
