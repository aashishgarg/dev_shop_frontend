                ...
                <div className="col-lg-6">
                    ...
                    <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                        ...
                        <li data-target="#carouselExampleIndicators" data-slide-to={0} className="active">
                            <img src={ require("../../../../../Assets/img/product/single-product/s-product-s-2.jpg")} alt='' />
                        </li>
                        <li data-target="#carouselExampleIndicators" data-slide-to={1}>
                            <img src={ require("../../../../../Assets/img/product/single-product/s-product-s-3.jpg")} alt='' />
                        </li>
                        <li data-target="#carouselExampleIndicators" data-slide-to={2}>
                            <img src={ require("../../../../../Assets/img/product/single-product/s-product-s-4.jpg")} alt='' />
                        </li>
                        </ol>
                        <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img className="d-block w-100" src={ require("../../../../../Assets/img/product/single-product/s-product-1.jpg")} alt="First slide" />
                        </div>
                        <div className="carousel-item">
                            <img className="d-block w-100" src={ require("../../../../../Assets/img/product/single-product/s-product-1.jpg")} alt="Second slide" />
                        </div>
                        <div className="carousel-item">
                            <img className="d-block w-100" src={ require("../../../../../Assets/img/product/single-product/s-product-1.jpg")} alt="Third slide" />
                        </div>
                        </div>
                    </div>
                    </div>
